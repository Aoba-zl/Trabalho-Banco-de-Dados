...
INSERT INTO user_tbl VALUES ('a', 'a', '11941318918', 'david@hotmail.com', 'store'); --apenas para login de test
INSERT INTO store VALUES ('a', 'pao de açucar', '10101010101010');
-----------------------------------------------------------------------------------------------------test
---------------------------------------------Insert Product------------------------------------------test
INSERT INTO product
VALUES 
('francisco', 'Goiaba', 1.50, 10, 2, 'Frutas', 'Uma fruta muito munita, chamado goiaba, muito melhor do que uma passagem de onibus.'),
('david', 'Passagem de onibus', 1.50, 10, 3, 'Ticket', 'Uma passagem de onibus muito munito, muito melhor do que comprar uma goiaba ne.'),
('francisco', 'seila', 2.50, 10, 5, 'Seilas', 'Sei la dos seilas.'),
('francisco', 'seila2', 5.50, 10, 6, 'Seilas', 'Sei la dos seilas que vem dos seilas.'),
('david', 'seila3', 10.50, 10, 9, 'Seilas', 'Sei la dos seilas que vem dos seilaaaas.'),
('david', 'seila4', 20.50, 10, 6, COALESCE(NULLIF('', ''), 'Sem categoria'), 'Sei la dos seilas que vem dos seilaaaaaaaas.')
